...
void feeder1(){
    ...
    printf("Philosopher 1 ate sauce %d at %f with forks 1 and 2\n", s, current);
    sem_post(&fork1);
    sem_post(&fork2);
}
...
void feeder2(){
    ...
    double current = (double) clock();
    current = current/CLOCKS_PER_SEC;
    printf("Philosopher 2 ate sauce %d at %f with forks 2 and 3\n", s, current);
    sem_post(&fork3);
    sem_post(&fork2);
}
...
void feeder3(){
    ...
    double current = (double) clock();
    current = current/CLOCKS_PER_SEC;
    printf("Philosopher 3 ate sauce %d at %f with forks 3 and 4\n", s, current);
    sem_post(&fork3);
    sem_post(&fork4);
}
...
void feeder4(){
    ...
    double current = (double) clock();
    current = current/CLOCKS_PER_SEC;
    printf("Philosopher 4 ate sauce %d at %f with forks 4 and 5\n", s, current);
    sem_post(&fork5);
    sem_post(&fork4);
}
...
void feeder5(){
    ...
    double current = (double) clock();
    current = current/CLOCKS_PER_SEC;
    printf("Philosopher 5 ate sauce %d at %f with forks 5 and 1\n", s, current);
    sem_post(&fork5);
    sem_post(&fork1);
}
